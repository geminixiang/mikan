...
| Office visibility and uniform projection (ADR 0008) | Implemented: platform-derived public/private, own dir rw, public view ro, shared knowledge rw/ro; no workspace-root mount; `full` retired (reported, not honored) |
