 ...
 * injects `window.__DSH_BOOT__` into index.html; the shell parses it here.
 */
...
/**
 * Parse `window.__DSH_BOOT__`. A missing or malformed graph throws (the shell
...
export function parseBootManifest(wire: unknown): WebBootGraph {
  if (typeof wire !== "object" || wire === null) {
    throw new Error("web-client: window.__DSH_BOOT__ is missing or not an object");
  }
