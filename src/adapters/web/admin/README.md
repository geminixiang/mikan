...
- `portal.ts`: Implements the `/admin` Web UI/API and its short-lived admin token store for conversations, models, sandbox, workspace door policy, skills, events, and links.
