...
| `sandbox.cpus`                 | `0.5`               | CPU limit for mikan-managed image containers                                                                |
| `sandbox.memory`               | `1g`                | Memory limit for mikan-managed image containers                                                             |
...
| `sandbox.image.workspaceMount` | `private`           | `private` exposes shared support files plus the current conversation; `full` exposes the complete workspace |
...
| `--sandbox=host \| container:<name> \| image:<image> \| microvm:default \| firecracker:... \| cloudflare:<id>` | Select tool execution mode; default is `host`                     |
