...
| **Harness/tools**      | `src/harness/`, `src/tools/`                                                      | Model turns, session-tree persistence, budgets, tool schemas, skills, subagents, and host capability calls                                         | `ConversationResponder` output and `Executor` operations; it does not receive platform SDK objects |
