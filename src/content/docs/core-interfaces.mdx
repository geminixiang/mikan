...
| **Config/CLI**         | `src/config.ts`, `src/settings-mutation.ts`, `src/cli/`, `src/adapters/commands/` | Boot/flag grammar, settings persistence, and the command manifest                                                                                                           | Effective settings and deterministic command inventory                                                                             |
