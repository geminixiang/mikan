...
<Features
  items={[
    ...
    },
    {
      ...
      body: "Run tool commands on the host, in a shared container, in a per-conversation container, or a local microVM.",
    },
    {
      icon: "lock",
    ...
    },
    {
      ...
      body: "A workspace-level MEMORY.md plus one per office, which the agent reads and writes as it works.",
    },
    {
      icon: "puzzle",
      title: "Skills & events",
...
<ArchBand
  ...
  tagline="Every conversation is an office: its own directory, its own sandbox, its own credentials. Inside one, mikan still keeps the transcript, the model loop, and the shell separate, so each can be inspected, swapped, or locked down on its own."
  lanes={[
    {
      name: "Chat record",
      verb: "feeds",
      body: "The platform-facing history — log.jsonl, attachments, and files, inside that office's directory.",
    },
    {
      name: "Agent session",
      verb: "drives",
