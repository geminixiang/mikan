...
`gondolin:default` は同じホスト上の detached Node worker を使用します。worker process と永続化された runtime inventory は restart recovery のための内部 lifecycle 境界であり、network worker protocol や remote placement contract はありません。
