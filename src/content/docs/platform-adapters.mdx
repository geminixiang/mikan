...
<CardGrid>
  ...
  <Card title="Response capability" icon="rocket">
    `ChatResponseContext` wraps replies, updates, typing/working state, and file uploads.
  </Card>
</CardGrid>
...
6. Create a `ChatResponseContext` that wraps replies, updates, typing/working state, and file uploads.
7. Hand the event to `BotHandler`, which is `SessionRuntime`.
...
| File                        | Purpose                                                                                               |
| --------------------------- | ----------------------------------------------------------------------------------------------------- |
| `src/adapter.ts`            | Exports shared interfaces such as `Bot`, `BotEvent`, `ChatMessage`, and `ChatResponseContext`.        |
...
- `ChatResponseContext`: the channel used by the agent to reply.
