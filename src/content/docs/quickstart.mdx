...
5. Start mikan with an empty workspace directory:
   ...
   The workspace is where the agent keeps per-conversation files: memory, attachments, session logs, and its working area.
