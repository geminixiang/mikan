...
| `gondolin:default`                                          | local Gondolin/QEMU VM    | not yet supported   | generated conversation vault      | Preview; mounts the current workspace at `/workspace`; requires Node.js >=23.6 and QEMU                  |
