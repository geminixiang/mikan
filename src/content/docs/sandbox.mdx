...
| `gondolin:remote`                                           | Gondolin VM on a remote worker | injected            | generated conversation vault      | Preview; mTLS `mikan-worker` daemon with fenced leases; workspace on shared POSIX storage                |
