---
title: Sessions
description: How mikan separates platform chat history from mikan structured sessions.
---
...
<CardGrid>
  ...
  <Card title="mikan structured context" icon="rocket">
    `sessions/*.jsonl` stores tool results and agent turns so the mikan harness can continue work.
  </Card>
...
- workspace/
  ...
  - sessions/
    ...
    - **\*.jsonl** structured mikan harness context, including tool results
