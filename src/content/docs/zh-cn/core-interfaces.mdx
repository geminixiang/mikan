...
| **Config/CLI/package** | `src/config.ts`、`src/settings-mutation.ts`、`src/cli/`、`src/commands/`、`src/packages/` | 启动/flag 语法、设置持久化、命令清单、package 物化与范围解析                                        | 生效设置、确定性的命令清单，以及只读的 package skill mount            |
