...
| **Harness/tools**      | `src/harness/`、`src/tools/`                                                      | 模型轮次、会话树持久化、预算、工具 schema、skill、subagent 和主机能力调用                           | `ConversationResponder` 输出与 `Executor` 操作；它不接收平台 SDK 对象 |
