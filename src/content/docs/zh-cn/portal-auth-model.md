...
| 功能                | 主要代码                                             |
| ------------------- | ---------------------------------------------------- |
| Portal HTTP 服务器  | `src/adapters/web/server.ts` 中的 `startWebServer()` |
| 管理 portal         | `src/adapters/web/admin/portal.ts`                   |
| 登录 / vault portal | `src/adapters/web/login/portal.ts`                   |
| 会话视图            | `src/adapters/web/session-view/portal.ts`            |
| 共享 token store    | `src/adapters/web/token-store.ts`                    |
| 共享 portal shell   | `src/adapters/web/portal-shell.ts`                   |
