...
- `gondolin-coordinator-lock.ts`: Crash-recoverable single-coordinator ownership for a remote Gondolin state directory; never breaks unreadable or cross-machine locks automatically.
