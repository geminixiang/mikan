...
- `index.ts`: Assembles core tools (read, bash, edit, write, event, sandbox, attach, react), exports the separately wired subagent tool factory, and merges optional `PlatformToolPack`s.
